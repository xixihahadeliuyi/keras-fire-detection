...
SAMPLE_SIZE = 50
#new  added video path
INPUT_VIDEO_PATH = os.path.sep.join(["input", "videos"])
OUTPUT_VIDEO_PATH = os.path.sep.join(["output", "videos"])
QUEUE_PATH = os.path.sep.join(["input", "size"])
LABEL_PATH = os.path.sep.join(["input", "label"])
